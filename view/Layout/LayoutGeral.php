<?php
 ...
 class LayoutGeral{
    ...
    private function gerar($conteudo, $titulo){
        ...
        $html .=    "<!-- Bootstrap CSS -->";
        $html .=    "<link rel='stylesheet' href='/Padrao_Dev_Php/content/Bootstrap/bootstrap-grid.min.css'>";
        $html .=    "<link rel='stylesheet' href='/Padrao_Dev_Php/content/Bootstrap/bootstrap-reboot.min.css'>";
        $html .=    "<link rel='stylesheet' href='/Padrao_Dev_Php/content/Bootstrap/bootstrap.min.css'>";
        $html .= "</head>";
        $html .= "<body>";
        $html .="<header>";
        ...
        $html .= "<script src='/Padrao_Dev_Php/script/lib/jquery-3.3.1.slim.min.js'></script>";
        $html .= "<script src='/Padrao_Dev_Php/script/lib/popper.min.js'></script>";
        $html .= "<script src='/Padrao_Dev_Php/script/Bootstrap/bootstrap.bundle.min.js'></script>";
        $html .= "<script src='/Padrao_Dev_Php  /script/Bootstrap/bootstrap.min.js'></script>";
        $html .= "</body>";
        $html .= "</html>";
        return $html;
    }
